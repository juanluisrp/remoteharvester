    ...
    container(
        ...
        shellScript {
            content = """
				...
				crane copy geocat.registry.jetbrains.space/p/jrc-inspire-portal/docker/csw-harvester:${'$'}BRANCH-${'$'}JB_SPACE_EXECUTION_NUMBER ${'$'}GEOCAT_DOCKER_REGISTRY_URL/jrc-geoportal/csw-harvester:${'$'}BRANCH
			"""
        }
    }
