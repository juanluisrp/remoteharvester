...
import net.geocat.events.Event;
 ...
 public class MetadataDocumentProcessedEvent extends Event {
    ...
    public MetadataDocumentProcessedEvent() {}

    public MetadataDocumentProcessedEvent(String linkCheckJobId, String harvestJobId,long endpointJobId, String sha2) {
     ...
     public String toString(){
         return "MetadataDocumentProcessedEvent - linkCheckJobId:"+linkCheckJobId+",harvestJobId:"+harvestJobId+", endpointjobid:"+endpointJobId+", sha2:"+sha2;
     }
 }
