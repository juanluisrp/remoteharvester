...
//    LocalServiceMetadataRecordRepo localServiceMetadataRecordRepo;
    ...
    public String getHtml(String identifier){
        ...
        for(InspireSpatialDatasetIdentifier inspireId : inspireIds) {
            result += "<a href='/api/html/capabilities/"+ inspireId.getCapabilitiesDocument().getLinkCheckJobId()+"/"+inspireId.getCapabilitiesDocument().getSha2()
                    +"'>" +inspireId.getCapabilitiesDocument().getLinkCheckJobId()+" :: "+inspireId.getCapabilitiesDocument().getSha2()+ "</a><bR>\n";
        }
        ...
        result += "<h2>Inspire Spatial Dataset Identifier - To Layer in capabilities</h2>";
        if (layers.isEmpty())
            result += "NO RESULTS<bR>";
        ...
        result += "<h2>Dataset - by dataset ID</h2>";
